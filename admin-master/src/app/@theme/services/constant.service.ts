...
export class ConstantService {
  ...
  END_TIME_LARGER = 'End time should be larger then From time';
  ...
  FROM_TIME = 'From time should be smaller then To Time';
  ...
  NO_INTERNET = 'Connection lost! You are offline.';
  ...
  SELECT_ALL_DATES = 'Please select From & To Dates';
  FROM_YEAR_SMALLER = 'From Year should be Smaller then To Year';
  SELECT_ALL_YEARS = 'Please select From & To Years';
  TO_DATE_GREATER = 'To Date should be greater then From Date';
