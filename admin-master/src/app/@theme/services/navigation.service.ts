...
export class NavigationService {
  ...
  navigateToCharges(data) {
    this.router.navigateByUrl(`/pages/caregiver/onboard/charges/${data}`);
  }
  navigateToAppointment(data) {
    this.router.navigateByUrl(`/pages/caregiver/onboard/appointments/${data}`);
  }
  navigateToWork(data) {
    this.router.navigateByUrl(`/pages/caregiver/onboard/work-experience/${data}`);
  }
  navigateToAvailability(data) {
    this.router.navigateByUrl(`/pages/caregiver/onboard/availability/${data}`);
  }
  navigateToSkillset(data) {
    this.router.navigateByUrl(`/pages/caregiver/onboard/skillset/${data}`);
  }
  navigateTopersonal(data) {
    this.router.navigateByUrl(`/pages/caregiver/onboard/personal-info/${data}`);
  }
  navigateToCaregiverList() {
    this.router.navigateByUrl(`/pages/caregiver/list`);
  }
  navigateToClientList() {
    this.router.navigateByUrl(`/pages/client`);
  }
  navigateToCompletedMatches() {
    this.router.navigateByUrl(`/pages/completed-matches`);
  }
  navigateToOutstandingMatches() {
    this.router.navigateByUrl(`pages/outstanding-matches`);
  }
}
